-- Complete database cleanup and setup for UrbanEdge Hoods
-- This script will clean everything and set up the real bomber jacket products
...
-- Step 2: Update categories to match real collection
-- First, delete existing categories
DELETE FROM categories;

-- Insert the correct category for bomber jackets
INSERT INTO categories (name, slug, description, featured, sort_order) VALUES
('UE Hoods Bomber Jackets', 'ue-hoods-bomber-jackets', 'Premium triple-layered bomber jackets with exclusive vector art designs. In-house manufactured with soft cushioning layer and waterproof outer fabric.', true, 1),
('T-Shirts', 't-shirts', 'Oversized cotton t-shirts with premium quality', false, 2),
('Hoodies', 'hoodies', '400 GSM heavy cotton fleece hoodies', false, 3),
('Shirts', 'shirts', 'Cuban collar shirts for partywear', false, 4),
('Originals', 'originals', 'Exclusive ORIGINALS collection', false, 5);

-- Step 3: Add the 8 real bomber jacket products
...
-- Step 4: Add product images for each bomber jacket
...
-- Step 5: Verify the data has been inserted correctly
-- Check products count
SELECT 'Products Count' as table_name, COUNT(*) as count FROM products
UNION ALL
SELECT 'Product Images Count' as table_name, COUNT(*) as count FROM product_images
UNION ALL
...
-- Show all categories
SELECT name, slug, description, featured FROM categories ORDER BY sort_order;
